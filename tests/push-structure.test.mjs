...
assert.match(html, /solid-physics-hands\.js\?build=20260729-solid-hands-v1/);
assert.match(html, /pipe-placement-v2\.js\?build=20260729-solid-hands-v1/);
assert.match(html, /structure-lab\.js\?build=20260729-solid-hands-v1/);
assert.match(solidHands, /removeScriptedPushers/);

console.log("Real weighted bodies, solid hands, aligned pipe models, physics goals, and visible/invisible collision-twin tests passed.");
